...
![](TIM截图20200106101426.png)

导航线：定义导航线，控件可以和导航线产生约束，如果导航线位置发生改变，控件的位置也会跟着改变
...
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <Button
        ...
        android:layout_height="wrap_content"
        android:text="缩小"
        app:layout_constraintBaseline_toBaselineOf="@id/btn_big"
        app:layout_constraintLeft_toRightOf="@id/btn_big" />
</androidx.constraintlayout.widget.ConstraintLayout>
```
...
class MainActivity : AppCompatActivity() {
    ...
    private val smallSet = ConstraintSet()
    private val bigSet = ConstraintSet()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        smallSet.clone(cl)
        bigSet.load(this, R.layout.view_big)
